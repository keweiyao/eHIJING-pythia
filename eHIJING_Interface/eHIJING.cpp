...
GHT_z_kt2_Table(4, {11,31,31,101}, // TA, ln(Q2/x), ln(kt2), ln(3+L/tauf) --> size and grid for H-T table -- 1
           {TAmin, std::log(1.0), std::log(2*mu2), std::log(5+.05)}, 
           {TAmax, std::log(1e2), std::log(1e2),  std::log(5+500)}
       ),
GHT_kt2_Table(4, {11,31,31,101}, // TA, ln(Q2/x), ln(kt2), ln(3+L*kt2/2E) --> size and grid for H-T table -- 2
           {TAmin, std::log(1.0), std::log(2*mu2), std::log(5+.05)}, 
           {TAmax, std::log(1e2), std::log(1e2),  std::log(5+500)}
       )
{
